            ...
            <div className="flex flex-wrap items-center gap-2">
              <button onClick={() => setShowMap((v) => !v)}
                className={`px-3 py-1.5 rounded-lg text-sm font-medium border transition-colors ${
                  showMap ? 'bg-blue-700 text-white border-blue-700' : 'bg-white text-blue-700 border-blue-300 hover:bg-blue-50'
                }`}>
                  ...
                  filtered.map((d) => (
                    <tr key={d.id}
                      ...
                      <td className="px-4 py-3">
                        ...
                        {isDelayed(d) && <span className="ml-1 px-1.5 py-0.5 rounded text-xs bg-red-200 text-red-700 font-semibold">지연</span>}
                      </td>
