    ...
    <div className="min-h-screen bg-purple-50">
      <nav className="bg-purple-700 text-white px-6 py-4 flex justify-between items-center shadow">
        <div className="flex items-center gap-4">
          ...
          <span className="text-xl font-bold">반품 신청</span>
        </div>
        <div className="flex items-center gap-4">
          <span className="hidden sm:inline text-sm text-purple-100">{user?.email}</span>
          <button onClick={handleLogout} className="bg-purple-900 hover:bg-purple-800 text-white text-sm px-4 py-1.5 rounded-lg transition-colors">
            로그아웃
          </button>
        </div>
      </nav>
