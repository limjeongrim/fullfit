      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-7">
          <div className="bg-white rounded-xl border border-purple-100 p-5">
            ...
            <p className="text-4xl font-bold text-purple-700">{data.length}</p>
          </div>
        ...
        {chartData.length > 0 && (
          <div className="bg-white rounded-xl shadow-sm border border-purple-100 p-5 mb-7">
            <h3 className="text-sm font-semibold text-gray-700 mb-4">재고 소진일수 <span className="text-gray-400 font-normal">(낮을수록 위험)</span></h3>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-purple-100 overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-purple-700 text-white">
              <tr>
                {['상품명', 'SKU', '현재재고', '일평균판매', '재고소진일수', '7일 예측', '30일 예측', '상태', '조치'].map(h => (
